    ...
    draw(context) {
        ...
        if (this.game.gameOver) {
            ...
            if (this.game.score > this.game.winningScore) {
                context.fillText('Congratulation, you win!!!', this.game.width * 0.5, this.game.height * 0.5 - 20)
                context.font = this.fontSize * 0.7 + 'px ' + this.fontFamily
                context.fillText('What are creatures of the night afraid of? YOU!!!', this.game.width * 0.5, this.game.height * 0.5 + 20)
                context.fillText('Press r to restart.', this.game.width * 0.5, this.game.height * 0.5 + 50)
            } else {
                context.fillText('May be next time', this.game.width * 0.5, this.game.height * 0.5 - 20)
                context.font = this.fontSize * 0.7 + 'px ' + this.fontFamily
